...
@SuppressLint("NewApi") public class Question6rActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.question_6r);
    ...
    private void setTexts(String categorie){
        ...
        ct=new CountDownTimer(15000,1000) {
            ...
            public void onFinish() {
                // TODO Auto-generated method stub
                Toast toast = new Toast(Question6rActivity.this);
                ImageView view = new ImageView(Question6rActivity.this);
                ...
                if(errors<2){
                    ...
                    new CountDownTimer(2000,2000) {				// 2000 ms is the duration of length_short
                        ...
                        public void onFinish() {
                            ...
                            questions++;
                            errors++;
                            setTexts(Question6rActivity.this.categorie);
                    ...
                    new CountDownTimer(2000,2000) {				// 2000 ms is the duration of length_short
                        ...
                        public void onFinish() {
                            // TODO Auto-generated method stub
                            Question6rActivity.this.finish();
    ...
    private String buildID(int int_ID, String suffixe, String isQorR)
    {
        ...
        q_ID = suffixe+"_"+isQorR+"_"+int_ID+"_n4";
        return q_ID;
    }
                ...
                if(rp.equals(reponse)){
                    ...
                    if(reponses<4){
                        ...
                        new CountDownTimer(2000,2000) {				// 2000 ms is the duration of length_short
                            ...
                            public void onFinish() {
                                // TODO Auto-generated method stub
                                Intent intent = new Intent(Question6rActivity.this,EnigmeLayoutActivity.class);
    ...
    public void onBackPressed() {
        new AlertDialog.Builder(Question6rActivity.this).setMessage("Are you sure you want to exit?")
