...
@SuppressLint("NewApi") public class Question4rActivity extends Activity {
    ...
    private void setTexts(String categorie){
        ...
        ct=new CountDownTimer(30000,1000) {
            ...
            public void onFinish() {
                // TODO Auto-generated method stub
                Toast toast = new Toast(Question4rActivity.this);
                ImageView view = new ImageView(Question4rActivity.this);
                ...
                if(errors<2){
                    ...
                    new CountDownTimer(2000,2000) {				// 2000 ms is the duration of length_short
                        ...
                        public void onFinish() {
                            ...
                            questions++;
                            errors++;
                            setTexts(Question4rActivity.this.categorie);
                    ...
                    new CountDownTimer(2000,2000) {				// 2000 ms is the duration of length_short
                        ...
                        public void onFinish() {
                            // TODO Auto-generated method stub
                            Question4rActivity.this.finish();
    ...
    private String buildID(int int_ID, String suffixe, String isQorR)
    {
        ...
        q_ID = suffixe+"_"+isQorR+"_"+int_ID+"_n2";
        return q_ID;
    }
                ...
                if(rp.equals(reponse)){
                    ...
                    if(reponses<4){
                        ...
                        new CountDownTimer(2000,2000) {				// 2000 ms is the duration of length_short
                            ...
                            public void onFinish() {
                                // TODO Auto-generated method stub
                                Intent intent = new Intent(Question4rActivity.this,EnigmeLayoutActivity.class);
    ...
    public void onBackPressed() {
        new AlertDialog.Builder(Question4rActivity.this).setMessage("Are you sure you want to exit?")
