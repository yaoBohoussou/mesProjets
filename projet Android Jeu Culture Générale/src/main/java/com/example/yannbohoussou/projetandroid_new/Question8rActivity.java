...
@SuppressLint("NewApi") public class Question8rActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.question_8r);
    ...
    private void setTexts(String categorie){
        ...
        ct=new CountDownTimer(15000,1000) {
            ...
            public void onFinish() {
                // TODO Auto-generated method stub
                Toast toast = new Toast(Question8rActivity.this);
                ImageView view = new ImageView(Question8rActivity.this);
                ...
                if(errors<2){
                    ...
                    new CountDownTimer(2000,2000) {				// 2000 ms is the duration of length_short
                        ...
                        public void onFinish() {
                            ...
                            questions++;
                            errors++;
                            setTexts(Question8rActivity.this.categorie);
                    ...
                    new CountDownTimer(2000,2000) {				// 2000 ms is the duration of length_short
                        ...
                        public void onFinish() {
                            // TODO Auto-generated method stub
                            Question8rActivity.this.finish();
    ...
    private String buildID(int int_ID, String suffixe, String isQorR)
    {
        ...
        q_ID = suffixe+"_"+isQorR+"_"+int_ID+"_n5";
        return q_ID;
    }
                ...
                if(rp.equals(reponse)){
                    ...
                    if(reponses<4){
                        ...
                        new CountDownTimer(2000,2000) {				// 2000 ms is the duration of length_short
                            ...
                            public void onFinish() {
                                // TODO Auto-generated method stub
                                Intent intent = new Intent(Question8rActivity.this,EnigmeLayoutActivity.class);
    ...
    public void onBackPressed() {
        new AlertDialog.Builder(Question8rActivity.this).setMessage("Are you sure you want to exit?")
